...
HD_PWD='/home/clrousse/4IR/Processeur/Processeur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Memoire_Instruction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Memoire_Instruction.tcl
