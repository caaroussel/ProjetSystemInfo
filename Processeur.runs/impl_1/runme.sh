...
HD_PWD='/home/clrousse/4IR/Processeur/Processeur.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Memoire_Instruction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Memoire_Instruction.tcl -notrace
